 ...
 * @author DUNG BUI
 */
public class BeginAppJFrame extends javax.swing.JFrame {

    /**
     * Creates new form BeginAppJFrame
     */
    public BeginAppJFrame() {
        initComponents();
    }
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jTextFieldIpAddress, javax.swing.GroupLayout.PREFERRED_SIZE, 208, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void jButtonConnectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConnectActionPerformed
        String idAdressString = this.jTextFieldIpAddress.getText();
        Integer portString = Integer.parseInt(this.jTextFieldPort.getText());
        try {
            Socket s = new Socket(idAdressString,portString);
            if(s != null){
                LoginJFrame loginJFrame = new LoginJFrame(s);
                loginJFrame.setVisible(true);
                this.setVisible(false);
            }
        } catch (IOException ex) {
            JOptionPane.showMessageDialog(null, "Connect fail!!!");
            Logger.getLogger(BeginAppJFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BeginAppJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BeginAppJFrame().setVisible(true);
            }
        });
    }
